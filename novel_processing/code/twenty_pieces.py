...
def total_char_sum(novel_num):
    ...
    for l in range(0,20):
        ...
        twenty_pieces.append(r) 
    return twenty_pieces    

def to_csv(novel_num):
    twenty_pieces = total_char_sum(novel_num)
    twenty_pieces.insert(0,novel_num)
    with open('twenty_pieces_9.csv', 'a') as f:
            writer = csv.writer(f)
            writer.writerow(twenty_pieces)     
